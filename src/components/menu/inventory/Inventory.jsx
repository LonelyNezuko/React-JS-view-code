		...
		draggableRef.current.map(item => {
			...
			$(item).droppable({
				...
				drop: (event, ui) => {
		            ...
		            // const targetItems = JSON.parse($(targetParent).attr('data-items'))
		            // const draggableItems = JSON.parse($(draggableParent).attr('data-items'))

		            // if(targetParent !== draggableParent) {
			        //     let tempItem = draggableItems[draggableID]

			        //     if(draggableParent === '#inventoryChar') tempItem = draggableItems[draggableID].item
			        //     if(targetParent === '#inventoryChar') tempItem = targetItems[targetID].item

			        //     if(draggableParent === '#inventoryNearby') {
			        //     	let addI = -1
		            // 		targetItems.map((item, i) => {
		            // 			if(!item.id && addI === -1) addI = i
		            // 		})

		            // 		if(addI !== -1) {
		            // 			targetItems[addI] = tempItem
			        //     		draggableItems.splice(draggableID, 1)
			        //     	}
			        //     }
			        //     else {
			        //     	if(draggableParent === '#inventoryChar') {
			        //     		draggableItems[draggableID].item = targetItems[targetID]
			        //     		targetItems[targetID] = tempItem
			        //     	}
			        //     	else if(targetParent === '#inventoryChar') {
			        //     		if(draggableItems[draggableID].char === undefined
			        //     			|| draggableItems[draggableID].char !== targetItems[targetID].id)return

			        //     		if((targetItems[targetID].id === 'weapon'
					// 				|| targetItems[targetID].id === 'ammo') && draggableItems[draggableID].id) {
			        //     			targetItems[targetID].item = draggableItems[draggableID]
			        //     			draggableItems[draggableID] = {}
			        //     		}
			        //     		else {
				    //         		targetItems[targetID].item = draggableItems[draggableID]
				    //         		draggableItems[draggableID] = tempItem
				    //         	}
			        //     	}
			        //     	else {
			        //     		draggableItems[draggableID] = targetItems[targetID]
			        //     		targetItems[targetID] = tempItem
			        //     	}
			        //     }

			        //     if(targetParent === '#inventoryMain') setItems(targetItems)
			        //     else if(targetParent === '#inventoryBackpack') setBackpack(targetItems)
			        //     else if(targetParent === '#inventoryChar') setCharList(targetItems)
			        //     else if(targetParent === '#inventoryFast') setFastList(targetItems)

			        //     if(draggableParent === '#inventoryMain') setItems(draggableItems)
			        //     else if(draggableParent === '#inventoryBackpack') setBackpack(draggableItems)
			        //     else if(draggableParent === '#inventoryNearby') setNearby(draggableItems)
			        //     else if(draggableParent === '#inventoryChar') setCharList(draggableItems)
			        //     else if(draggableParent === '#inventoryFast') setFastList(draggableItems)
			        // }
			    	// else {
			    	// 	const tempItem = targetItems[draggableID]

			    	// 	targetItems[draggableID] = targetItems[targetID]
			    	// 	targetItems[targetID] = tempItem
			...
			$('.inventory #inventoryNearby .inventory-body-items').droppable({
				...
				drop: (event, ui) => {
		            ...
		            // const nearbyItems = JSON.parse($('.inventory #inventoryNearby').attr('data-items'))
		            // const draggableItems = JSON.parse($(draggableParent).attr('data-items'))

		            // if(draggableParent === '#inventoryFast') {
		           	// 	draggableItems[draggableID] = -1
		           	// 	setFastList(draggableItems)
		           		
		           	// 	return
		           	// }

		            // if(draggableParent === '#inventoryChar') {
		            // 	nearbyItems.push(draggableItems[draggableID].item)
		            // 	draggableItems[draggableID].item = {}
		            // }
	            	// else {
	            	// 	nearbyItems.push(draggableItems[draggableID])
	            	// 	draggableItems[draggableID] = {}
	            	// }
